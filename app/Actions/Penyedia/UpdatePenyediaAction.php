...
class UpdatePenyediaAction
{
    ...
    public function execute(PenyediaRequest $request, Penyedia $penyedia): Penyedia
    {
        $media = $this->penyediaMediaService->buildMediaPayload($request, $penyedia);

        return $this->penyediaRepository->update($penyedia, [
