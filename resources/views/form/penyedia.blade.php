                        ...
                        <div>
                            ...
                            <div class="mt-4">
                                ...
                                @if ($penyedia->kop_surat)
                                    <div class="mb-2 text-sm text-green-600">
                                        <strong>{{ basename($penyedia->kop_surat) }}</strong>
                                    </div>
                                @endif
                                <input id="kop_surat" name="kop_surat" type="file" accept=".pdf,.jpg,.jpeg,.png,.gif,.svg" class="mt-1 block w-full">
                                <x-input-error class="mt-2" :messages="$errors->get('kop_surat')" />
                                @if($penyedia->exists && $penyedia->kop_surat)
                                    <label class="mt-2 flex items-center gap-2 text-sm text-gray-700">
