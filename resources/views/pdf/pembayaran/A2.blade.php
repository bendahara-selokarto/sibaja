...
<body style="margin: 50px 50px 300px 50px; line-height: 1; vertical-align:text-top; ">
    ...
    <table style="width: 100%; border-bottom: 1px solid black; margin:0px">        
        ...
        <tr>
            ...
            <td style="font-weight: bold;">: </td>
            <td style="font-weight: bold; text-transform: uppercase;"></td>
    ...
    <tr>
            ...
            <table style="width: 100%; margin-top: 20px;">
                ...
                <tr>
                    ...
                    <td style="vertical-align: top; padding: 5px;">
                        <strong>Rp 61.321.000</strong><br>
                        <em>enam puluh satu juta tiga ratus dua puluh satu ribu rupiah</em>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td style="vertical-align: top; width: 4pt; padding: 5px;">:</td>
                    <td style="vertical-align: top; padding: 5px;">Pengaspalan Jalan RT 02 (Endrokilo)</td>
                </tr>
            </table>
        </td>
        ...
        <td style="width: 42%; vertical-align: top; padding-left: 20px; border: 1px solid black;" cellpadding="2">
            ...
            <table style="width: 100%; margin-top: 5px;">
                <tr><td>1. PPh 21</td><td>Rp -</td></tr>
                <tr><td>2. PPh 22</td><td>Rp 828.662</td></tr>
                <tr><td>3. PPh 23</td><td>Rp -</td></tr>
                <tr><td>4. PPN</td><td>Rp 6.076.856</td></tr>
            </table>
        </td>
    </tr>
</table>
...
<div style="text-align: center; margin-left:auto; width:300px">
    <p style="margin-top: 30px;">Gemuh, 17 Juni 2025</p>
    <p>Yang menerima</p>

</div>

    <div style="border: 2px solid black; display: inline-block; padding: 10px 20px; margin: 20px;">
        <strong style="font-size: 18px;">LUNAS DIBAYAR</strong><br>
        <span style="font-style: italic;">17 Juni 2025</span>
    </div>
    ...
    <table style="width: 100%; text-align: center; margin-top: 40px;">
        <tr>
            <td style="border: 1px solid black" >Setuju dibayarkan<br>Kepala Desa Gemuh <br><br><br><br><br></td>
            <td style="border: 1px solid black" >Telah di Verifikasi<br>Sekretaris Desa <br><br><br><br><br></td>
            <td style="border: 1px solid black" >Telah dibayarkan<br>Kaur Keuangan <br><br><br><br><br></td>
            <td style="border: 1px solid black" >Pelaksana Kegiatan<br>Kasi Kesejahteraan <br><br><br><br><br></td>
        </tr>      
    </table>
