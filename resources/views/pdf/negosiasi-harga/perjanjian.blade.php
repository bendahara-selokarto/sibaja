...
<p style="text-align: justify">Apabila pekerjaan melebihi batas waktu yang disepakati maka PIHAK KEDUA harus membayar denda sebesar 10% dari nilai pekerjaan dengan nominal pengadaan material dari jumlah total yang akan dikirim sebesar Rp. {{ number_format(\App\Support\Money::multiplyBasisPoints($data['negosiasiHarga']->harga_total, 1000), 0, ',', '.') }},- ( {{ Terbilang::make(\App\Support\Money::multiplyBasisPoints($data['negosiasiHarga']->harga_total, 1000)) }} rupiah ).</p>
