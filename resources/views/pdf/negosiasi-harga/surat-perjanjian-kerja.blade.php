...
<table style="width: 100%; padding: 5px">
    ...
    <tbody>
        <tr>
            ...
            <td style="border: 1px solid black; vertical-align:top; text-align:right">{{ formatNumber($data['negosiasiHarga']->harga_total) }}</td>
            <td style="border: 1px solid black; vertical-align:top; text-align:right">{{ formatNumber($data['negosiasiHarga']->harga_total) }}</td>
        </tr>
        <tr>
            <td colspan="4" style="border: 1px solid black; vertical-align:top; text-align:right"><strong>Jumlah</strong></td>
            <td style="border: 1px solid black; vertical-align:top; text-align:right"><strong>{{ formatNumber($data['negosiasiHarga']->harga_total) }}</strong></td>
        </tr>       
    </tbody>
</table>
<br>
